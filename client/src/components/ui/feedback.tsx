...
import { Angry, Check, Frown, Loader2, Smile, Laugh } from 'lucide-react'
  ...
  return (
    <motion.div
      ...
      <span className="flex items-center justify-center gap-3 pl-4 pr-2">
        <div className="text-sm text-black dark:text-neutral-400">How's your experience?</div>
            ...
            <button
              ...
              className={twMerge(
                happiness === e.happiness
                  ? 'bg-primary/10 stroke-primary dark:bg-primary/20 dark:stroke-primary'
                  : 'stroke-neutral-500 dark:stroke-neutral-400',
                'flex h-8 w-8 items-center justify-center rounded-full transition-all hover:bg-primary/10 hover:stroke-primary hover:dark:bg-primary/20 hover:dark:stroke-primary'
              )}
              key={e.happiness}>
              {e.emoji}
            </button>
        ...
        <AnimatePresence>
          {!isSubmitted ? (
            ...
            <motion.div
              ...
              <motion.div
                variants={item}
                className="flex h-8 min-h-8 w-8 min-w-8 items-center justify-center rounded-full bg-primary dark:bg-primary">
